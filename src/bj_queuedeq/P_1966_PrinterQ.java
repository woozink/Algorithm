    ...
    public static void main(String[] args) throws IOException {
        ...
        while(T -- >0){
            ...
            while (!q.isEmpty()){ // 한 케이스에 대한 반복문
                ...
                boolean isMax = true; // front 원소가 갖아 큰 원소인지를 판단하는 변수
                //큐에 남아 있는 원소들과 중요도를 비교
                for(int i = 0; i <q.size(); i++){
                    //처음 뽑은 원소보다 큐에 있는 i 번째 원소가  중요도가 클 경우
                ...
                //front원소가 가장 큰 원소가 아니었으므로 다음 반복문으로 넘어감
                if(isMax == false){
                    continue;
                }

                //front원소가 가장 큰 원소였으므로 해당 원소는 출력해야한다.
                count ++;
